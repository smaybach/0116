...
import com.example.dingdan.adapter.OrderAdapter;
...
public class Fragment1 extends BaesFragmentActivity<OrderPresenter> implements IOrderView {
    @BindView(R.id.recy)
    RecyclerView recy;
    Unbinder unbinder;
    ...
    public void showOrder(List<OrderBean.DataBean> list) {
        ...
        OrderAdapter orderAdapter = new OrderAdapter(getActivity(), list, presenter);
